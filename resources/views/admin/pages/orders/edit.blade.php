                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="status">
                                            ...
                                            <option {{ $order->status == 'active' ? 'selected' : '' }} value="active">Active
                                            </option>
                                            <option {{ $order->status == 'inactive' ? 'selected' : '' }} value="inactive">
                                                Inactive</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="user_id">
                                            ...
                                            @foreach ($clients as $client)
                                                <option {{ $order->user_id == $client->id ? 'selected' : '' }}
                                                    value="{{ $client->id }}">{{ $client->username }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="project">
                                            ...
                                            @foreach ($discounts as $discount)
                                                <option {{ $order->discount_id == $discount->id ? 'selected' : '' }}
                                                    value="{{ $discount->id }}">{{ $discount->discount_percentage }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
