                ...
                <div class="card-body">
                    <form action="{{ route('admin.clients.update', $client->id) }}" method="POST"
                            ...
                            <div class="col-xl-2">
                                <div class="mb-5">
                                    <img id="showImage" width="100px"
                                        src="{{ $client->image == '' ? url('admin/no-image.png') : asset($client->image) }}">
                                </div>
                            </div>
                            <div class="col-xl-10">
                                <div class="mb-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="mb-5">
                                    <label class="text-dark font-weight-medium">User Status</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                        ...
                                        <select class="form-control" name="status">
                                            ...
                                            <option {{ $client->status == 'active' ? 'selected' : '' }} value="active">
                                                Active</option>
                                            <option {{ $client->status == 'inactive' ? 'selected' : '' }} value="inactive">
                                                Inactive</option>
                                        </select>
                                    </div>
                                </div>
